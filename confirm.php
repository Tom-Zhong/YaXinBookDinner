...
$book_confirm=$_POST['book_confirm'];
$book_dish_name=$_POST['book_dish_name'];
//准备sql语句

$sql="update book_dinner_info set book_state=".$book_confirm.",dish_name='".$book_dish_name."',createtime=now() where name='".$book_name."'";
